...
public interface TemplateTestSendRecordRepository extends JpaRepository<TemplateTestSendRecord, String> {
    List<TemplateTestSendRecord> findByTenantIdAndWorkspaceIdAndTemplateIdAndDeletedAtIsNullOrderByCreatedAtDesc(String tenantId, String workspaceId, String templateId);
}
