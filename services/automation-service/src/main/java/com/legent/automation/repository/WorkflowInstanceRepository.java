...
public interface WorkflowInstanceRepository extends JpaRepository<WorkflowInstance, String> {
    ...
    java.util.List<WorkflowInstance> findByTenantIdAndWorkspaceIdAndWorkflowIdOrderByCreatedAtDesc(String tenantId, String workspaceId, String workflowId, Pageable pageable);
}
