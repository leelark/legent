...
```text
shared/         Java shared libraries
services/       Spring Boot microservices
frontend/       Next.js workspace and public app
infrastructure/ Docker and Kubernetes infrastructure
scripts/        setup, build, cache, ops scripts
docs/           existing project docs
```

## Maven Modules

Backend root `pom.xml` declares shared modules and 10 Spring Boot services. Maven wrapper should be used for reproducible local builds.
...
- `(workspace)` layout is re-exported under `/app` routes.
- API client centralizes URL resolution, credentials, tenant/workspace headers, request IDs, and auth redirects.
- Zustand stores manage auth, tenant, toast, and UI state.
- Playwright tests mock API boundaries for deterministic product workflow validation.

## API Convention

- Base path: `/api/v1`.
- Response shape: `success`, `data`, `error`, `meta` or pagination wrapper.
- Required headers: `X-Tenant-Id`, `X-Workspace-Id`, `X-Request-Id` for workspace-scoped requests.
- Auth endpoints and selected public tracking/health endpoints are tenant-free.
...
| Module | Kind | Detail | Source |
| --- | --- | --- | --- |
| audience-service | publisher/helper | TOPIC_EMAIL_SEND_REQUESTED, TOPIC_SUBSCRIBER_UPDATED | services/audience-service/src/main/java/com/legent/audience/event/AudienceEventPublisher.java |
| audience-service | listener | topics = AppConstants.TOPIC_TRACKING_INGESTED, groupId = "audience-tracking-group" | services/audience-service/src/main/java/com/legent/audience/event/AudienceIntelligenceConsumer.java |
| audience-service | listener | topics = { AppConstants.TOPIC_WORKFLOW_STARTED, AppConstants.TOPIC_WORKFLOW_STEP_COMPLETED, AppConstants.TOPIC_WORKFLOW_COMPLETED }, groupId = "audience-automation-group" | services/audience-service/src/main/java/com/legent/audience/event/AudienceIntelligenceConsumer.java |
| audience-service | listener | topics = AppConstants.TOPIC_AUDIENCE_RESOLUTION_REQUESTED, groupId = AppConstants.GROUP_AUDIENCE | services/audience-service/src/main/java/com/legent/audience/event/AudienceResolutionConsumer.java |
| audience-service | publisher/helper | TOPIC_AUDIENCE_RESOLUTION_REQUESTED, TOPIC_AUDIENCE_RESOLVED | services/audience-service/src/main/java/com/legent/audience/event/AudienceResolutionConsumer.java |
| audience-service | listener | topics = { AppConstants.TOPIC_EMAIL_BOUNCED, AppConstants.TOPIC_EMAIL_UNSUBSCRIBED, AppConstants.TOPIC_EMAIL_COMPLAINT }, groupId = "audience-delivery-group" | services/audience-service/src/main/java/com/legent/audience/event/DeliveryEventConsumer.java |
| audience-service | publisher/helper | TOPIC_IMPORT_COMPLETED, TOPIC_IMPORT_FAILED, TOPIC_IMPORT_STARTED | services/audience-service/src/main/java/com/legent/audience/event/ImportEventPublisher.java |
| audience-service | publisher/helper | TOPIC_SEGMENT_CREATED, TOPIC_SEGMENT_RECOMPUTED, TOPIC_SEGMENT_UPDATED | services/audience-service/src/main/java/com/legent/audience/event/SegmentEventPublisher.java |
| audience-service | publisher/helper | TOPIC_SUBSCRIBER_CREATED, TOPIC_SUBSCRIBER_DELETED, TOPIC_SUBSCRIBER_UPDATED | services/audience-service/src/main/java/com/legent/audience/event/SubscriberEventPublisher.java |
| audience-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/audience-service/src/main/java/com/legent/audience/service/ConsentService.java |
| audience-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/audience-service/src/main/java/com/legent/audience/service/ImportProcessingService.java |
| audience-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/audience-service/src/main/java/com/legent/audience/service/ImportService.java |
| audience-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/audience-service/src/main/java/com/legent/audience/service/SegmentEvaluationService.java |
| audience-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/audience-service/src/main/java/com/legent/audience/service/SegmentService.java |
| audience-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/audience-service/src/main/java/com/legent/audience/service/SubscriberService.java |
| audience-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/audience-service/src/test/java/com/legent/audience/service/SegmentEvaluationServiceTest.java |
| audience-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/audience-service/src/test/java/com/legent/audience/service/SubscriberServiceTest.java |
| automation-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/automation-service/src/main/java/com/legent/automation/event/WorkflowEventPublisher.java |
| automation-service | listener | topics = AppConstants.TOPIC_WORKFLOW_TRIGGER, groupId = AppConstants.GROUP_AUTOMATION | services/automation-service/src/main/java/com/legent/automation/event/WorkflowTriggerConsumer.java |
| automation-service | publisher/helper | TOPIC_SEND_REQUESTED | services/automation-service/src/main/java/com/legent/automation/service/node/SendEmailNodeHandler.java |
| automation-service | publisher/helper | TOPIC_WORKFLOW_TRIGGER | services/automation-service/src/main/java/com/legent/automation/service/node/WorkflowScheduleTriggerJob.java |
| automation-service | publisher/helper | TOPIC_WORKFLOW_COMPLETED, TOPIC_WORKFLOW_STARTED, TOPIC_WORKFLOW_STEP_COMPLETED, TOPIC_WORKFLOW_STEP_FAILED, TOPIC_WORKFLOW_STEP_STARTED | services/automation-service/src/main/java/com/legent/automation/service/WorkflowEngine.java |
| automation-service | publisher/helper | TOPIC_WORKFLOW_TRIGGER | services/automation-service/src/main/java/com/legent/automation/service/WorkflowStudioService.java |
| automation-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/automation-service/src/test/java/com/legent/automation/service/WorkflowEngineTest.java |
| campaign-service | listener | topics = AppConstants.TOPIC_AUDIENCE_RESOLVED, groupId = AppConstants.GROUP_CAMPAIGN | services/campaign-service/src/main/java/com/legent/campaign/event/CampaignEventConsumer.java |
| campaign-service | listener | topics = AppConstants.TOPIC_SEND_PROCESSING, groupId = AppConstants.GROUP_CAMPAIGN, concurrency = "3" | services/campaign-service/src/main/java/com/legent/campaign/event/CampaignEventConsumer.java |
| campaign-service | listener | topics = AppConstants.TOPIC_BATCH_CREATED, groupId = AppConstants.GROUP_CAMPAIGN, concurrency = "3" | services/campaign-service/src/main/java/com/legent/campaign/event/CampaignEventConsumer.java |
| campaign-service | listener | topics = AppConstants.TOPIC_SEND_REQUESTED, groupId = AppConstants.GROUP_CAMPAIGN, concurrency = "2" | services/campaign-service/src/main/java/com/legent/campaign/event/CampaignEventConsumer.java |
| campaign-service | listener | topics = AppConstants.TOPIC_EMAIL_SENT, groupId = AppConstants.GROUP_CAMPAIGN, concurrency = "5" | services/campaign-service/src/main/java/com/legent/campaign/event/CampaignEventConsumer.java |
| campaign-service | listener | topics = AppConstants.TOPIC_EMAIL_FAILED, groupId = AppConstants.GROUP_CAMPAIGN, concurrency = "5" | services/campaign-service/src/main/java/com/legent/campaign/event/CampaignEventConsumer.java |
| campaign-service | listener | topics = AppConstants.TOPIC_TRACKING_INGESTED, groupId = AppConstants.GROUP_CAMPAIGN + "-experiment-metrics", concurrency = "3" | services/campaign-service/src/main/java/com/legent/campaign/event/CampaignEventConsumer.java |
| campaign-service | publisher/helper | TOPIC_AUDIENCE_RESOLUTION_REQUESTED, TOPIC_BATCH_CREATED, TOPIC_SEND_PROCESSING, TOPIC_SEND_REQUESTED | services/campaign-service/src/main/java/com/legent/campaign/event/CampaignEventPublisher.java |
| campaign-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/campaign-service/src/main/java/com/legent/campaign/service/BatchingService.java |
| campaign-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/campaign-service/src/main/java/com/legent/campaign/service/CampaignEngineService.java |
| campaign-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/campaign-service/src/main/java/com/legent/campaign/service/OrchestrationService.java |
| campaign-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/campaign-service/src/main/java/com/legent/campaign/service/SchedulingService.java |
| campaign-service | publisher/helper | TOPIC_BATCH_CREATED, TOPIC_EMAIL_SEND_REQUESTED, TOPIC_SEND_FAILED | services/campaign-service/src/main/java/com/legent/campaign/service/SendExecutionService.java |
| campaign-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/campaign-service/src/test/java/com/legent/campaign/service/BatchingServiceTest.java |
| campaign-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/campaign-service/src/test/java/com/legent/campaign/service/OrchestrationServiceTest.java |
| content-service | publisher/helper | TOPIC_CONTENT_PUBLISHED | services/content-service/src/main/java/com/legent/content/event/ContentEventPublisher.java |
| content-service | publisher/helper | TOPIC_EMAIL_SEND_REQUESTED | services/content-service/src/main/java/com/legent/content/service/TemplateService.java |
| content-service | publisher/helper | TOPIC_EMAIL_SEND_REQUESTED | services/content-service/src/main/java/com/legent/content/service/TemplateTestSendService.java |
| content-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/content-service/src/main/java/com/legent/content/service/TemplateVersionService.java |
| content-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/content-service/src/main/java/com/legent/content/service/TemplateWorkflowService.java |
| deliverability-service | listener | topics = {AppConstants.TOPIC_EMAIL_BOUNCED, AppConstants.TOPIC_EMAIL_COMPLAINT}, groupId = AppConstants.GROUP_DELIVERABILITY | services/deliverability-service/src/main/java/com/legent/deliverability/event/FeedbackLoopConsumer.java |
| delivery-service | listener | topics = AppConstants.TOPIC_EMAIL_SEND_REQUESTED, groupId = AppConstants.GROUP_DELIVERY, concurrency = "5" | services/delivery-service/src/main/java/com/legent/delivery/event/DeliveryEventConsumer.java |
| delivery-service | publisher/helper | TOPIC_EMAIL_BOUNCED, TOPIC_EMAIL_FAILED, TOPIC_EMAIL_RETRY_SCHEDULED, TOPIC_EMAIL_SENT | services/delivery-service/src/main/java/com/legent/delivery/event/DeliveryEventPublisher.java |
| delivery-service | listener | topics = AppConstants.TOPIC_EMAIL_FAILED, groupId = AppConstants.GROUP_DELIVERY_FAILED, concurrency = "3" | services/delivery-service/src/main/java/com/legent/delivery/event/EmailFailedConsumer.java |
| delivery-service | publisher/helper | TOPIC_EMAIL_FAILED, TOPIC_EMAIL_FAILED_DLQ, TOPIC_EMAIL_RETRY_SCHEDULED | services/delivery-service/src/main/java/com/legent/delivery/event/EmailFailedConsumer.java |
| delivery-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/delivery-service/src/main/java/com/legent/delivery/service/DeliveryOrchestrationService.java |
| delivery-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/delivery-service/src/test/java/com/legent/delivery/service/DeliveryOrchestrationServiceTest.java |
| foundation-service | publisher/helper | TOPIC_SYSTEM_INITIALIZED | services/foundation-service/src/main/java/com/legent/foundation/event/SystemInitializedPublisher.java |
| foundation-service | listener | topics = AppConstants.TOPIC_TENANT_BOOTSTRAP_REQUESTED, groupId = AppConstants.GROUP_FOUNDATION_BOOTSTRAP | services/foundation-service/src/main/java/com/legent/foundation/event/TenantBootstrapConsumer.java |
| foundation-service | listener | topics = AppConstants.TOPIC_IDENTITY_USER_SIGNUP, groupId = AppConstants.GROUP_FOUNDATION_PROVISIONING | services/foundation-service/src/main/java/com/legent/foundation/event/TenantProvisioningConsumer.java |
| foundation-service | publisher/helper | TOPIC_CONFIG_UPDATED | services/foundation-service/src/main/java/com/legent/foundation/service/ConfigService.java |
| foundation-service | publisher/helper | TOPIC_TENANT_BOOTSTRAP_COMPLETED, TOPIC_TENANT_BOOTSTRAP_REQUESTED | services/foundation-service/src/main/java/com/legent/foundation/service/TenantBootstrapService.java |
| foundation-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/foundation-service/src/test/java/com/legent/foundation/service/ConfigServiceTest.java |
| identity-service | publisher/helper | TOPIC_EMAIL_SEND_REQUESTED, TOPIC_IDENTITY_USER_SIGNUP | services/identity-service/src/main/java/com/legent/identity/event/IdentityEventPublisher.java |
| identity-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/identity-service/src/main/java/com/legent/identity/service/AuthService.java |
| identity-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/identity-service/src/main/java/com/legent/identity/service/IdentityExperienceService.java |
| identity-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/identity-service/src/test/java/com/legent/identity/service/AuthServiceTest.java |
| platform-service | listener | topics = {AppConstants.TOPIC_WEBHOOK_TRIGGERED}, groupId = AppConstants.GROUP_PLATFORM | services/platform-service/src/main/java/com/legent/platform/event/PlatformEventConsumer.java |
| platform-service | listener | topics = {AppConstants.TOPIC_NOTIFICATION_CREATED}, groupId = AppConstants.GROUP_PLATFORM | services/platform-service/src/main/java/com/legent/platform/event/PlatformEventConsumer.java |
| platform-service | listener | topics = {AppConstants.TOPIC_SEARCH_INDEX_UPDATED}, groupId = AppConstants.GROUP_PLATFORM | services/platform-service/src/main/java/com/legent/platform/event/PlatformEventConsumer.java |
| tracking-service | listener | topics = AppConstants.TOPIC_TRACKING_INGESTED, groupId = "tracking-clickhouse-group" | services/tracking-service/src/main/java/com/legent/tracking/event/TrackingEventConsumer.java |
| tracking-service | publisher/helper | TOPIC_CONVERSION_EVENT, TOPIC_EMAIL_CLICK, TOPIC_EMAIL_OPEN, TOPIC_TRACKING_INGESTED | services/tracking-service/src/main/java/com/legent/tracking/event/TrackingEventPublisher.java |
| tracking-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/tracking-service/src/main/java/com/legent/tracking/service/TrackingIngestionService.java |
| tracking-service | publisher/helper | EventPublisher/KafkaTemplate usage | services/tracking-service/src/test/java/com/legent/tracking/service/TrackingIngestionServiceTest.java |
| legent-kafka | publisher/helper | EventPublisher/KafkaTemplate usage | shared/legent-kafka/src/main/java/com/legent/kafka/config/KafkaProducerConfig.java |
| legent-kafka | publisher/helper | EventPublisher/KafkaTemplate usage | shared/legent-kafka/src/main/java/com/legent/kafka/consumer/DlqHandler.java |
| legent-kafka | publisher/helper | EventPublisher/KafkaTemplate usage | shared/legent-kafka/src/main/java/com/legent/kafka/producer/EventPublisher.java |
