...
Write-Host "Ready work: $(@($queue.readyWork).Count)"
...
$next = @($queue.readyWork) | Sort-Object -Property @{Expression = { [int]$_.priorityScore }; Descending = $true } | Select-Object -First 1
if ($next) {
