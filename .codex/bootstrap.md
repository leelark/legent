...
- Current external blockers: production external egress still needs real managed-service/provider CIDR/port data or approved CNI FQDN policy; audience V17 production mapping metadata, shared workspace membership authorization contract, and real target-environment synthetic smoke/load/restore/security/monitoring evidence remain required.
