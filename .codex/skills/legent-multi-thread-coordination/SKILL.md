...
2. Choose mode: `OVERALL`, `MODULE`, or `HYBRID`.
...
6. Monitor with `.codex/utilities/monitor-autonomous-org.ps1`.
7. Validate with `.codex/utilities/validate-codex-system.ps1`.
8. Close threads and release leases after handoff.
